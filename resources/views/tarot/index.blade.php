    ...
    <div class="py-8 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow p-6"
                 x-data="{ style: 'mystic', loading: false }">
                ...
                <form action="{{ route('tarot.store') }}" method="POST" @submit="loading = true">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="question" rows="4"
                            ...
                            :class="loading ? 'opacity-50' : ''">{{ old('question') }}</textarea>
                        @error('question')
                    ...
                    <button type="submit"
                        :disabled="loading"
                        class="w-full py-3 px-6 rounded-xl font-medium text-white transition-all duration-200 disabled:opacity-60"
                        :class="style === 'mystic'
